import { MapPin, Calendar, Tag, Trash2, Lightbulb, Droplets, Droplet, Construction, Car, AlertCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row gap-5">
        ...
        {complaint.image_url ? (
          <div className="w-full sm:w-44 h-44 sm:h-28 rounded-2xl overflow-hidden shadow-md shrink-0 relative">
            <img 
              src={`${backendUrl}${complaint.image_url}`} 
              alt={complaint.title} 
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-center space-x-4 mt-3 text-[11px] font-semibold text-slate-500 border-t border-white/5 pt-3">
            <div className="flex items-center space-x-1">
              ...
              <span className="text-slate-400">Main Street Sector-4</span> {/* Static or dynamic location */}
            </div>
            <div className="flex items-center space-x-1">
        ...
        <div className="flex flex-row sm:flex-col justify-between items-end shrink-0 sm:border-l sm:border-white/5 sm:pl-5 pt-3 sm:pt-0">
          ...
          <button className="flex items-center space-x-1 text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors group/btn cursor-pointer">
